  ...
  <x-sidebar>
    <x-slot:title> {{ $title }} </x-slot:title>
      ...
      <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          <h2 class="mb-6 text-xl font-bold text-gray-900 dark:text-white pl-2 border-l-4 border-primary-700 dark:border-white">Input Barang Keluar Selain Penjualan</h2>
                ...
                <div class="w-full col-span-2">
                    ...
                    <select id="product" name="product_id" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                        ...
                        @foreach ($productions as $production)
                            <option value="{{ $production->product_id }}" data-sisa-stok="{{ $production->stok_masuk }}" 
